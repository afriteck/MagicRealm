...
public class Iteration1Board {
	...
	public static void it1Board(BoardTiles bt) {
		...
		// bt.getTile("AWFUL VALLEY").getClearingByNum(5).setDwelling(new
		// Dwelling("Chapel", "/dwellings/chapel.gif"));

		/*
		 * 
		 * bt.getTile("AWFUL VALLEY").getClearingByNum(5).setDwelling(chapel);
		 * bt
		 * .getTile("DARK VALLEY").getClearingByNum(5).setDwelling(guardhouse);
